...
public class backgroundWorkerTakeCharge extends AsyncTask<String, Void, String> {
    Context context;
    AlertDialog alertDialog;
    backgroundWorkerTakeCharge(Context context) {
    ...
    protected void onPostExecute(String result) {
        alertDialog.setTitle("Prise en charge de l'essaim");
